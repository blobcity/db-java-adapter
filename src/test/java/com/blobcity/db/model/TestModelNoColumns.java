...
@Entity(table = TestModelNoColumns.TABLE_NAME_REFERENCE)
public class TestModelNoColumns extends CloudStorage {

    private static final transient Logger logger = Logger.getLogger(TestModelNoColumns.class.getName());
    public static final String TABLE_NAME_REFERENCE = "TableModelNo";
    ...
    public TestModelNoColumns() {
        // do nothing
    }

    public TestModelNoColumns(final String parsableStr) {
    ...
    public boolean equals(Object obj) {
        ...
        final TestModelNoColumns other = (TestModelNoColumns) obj;
