...
@Entity(table = TestModelAllColumns.TABLE_NAME_REFERENCE)
public class TestModelAllColumns extends CloudStorage {

    private final transient Logger logger = Logger.getLogger(TestModelAllColumns.class.getName());
    public static final String TABLE_NAME_REFERENCE = "TableModelAll";
    ...
    public TestModelAllColumns() {
        // do nothing
    }

    public TestModelAllColumns(final String parsableStr) {
    ...
    public boolean equals(Object obj) {
        ...
        final TestModelAllColumns other = (TestModelAllColumns) obj;
