...
@Entity(table = TestModelSomeColumns.TABLE_NAME_REFERENCE)
public class TestModelSomeColumns extends CloudStorage {

    private final transient Logger logger = Logger.getLogger(TestModelSomeColumns.class.getName());
    public static final String TABLE_NAME_REFERENCE = "TableModelSome";
    ...
    public TestModelSomeColumns() {
        // do nothing
    }

    public TestModelSomeColumns(final String parsableStr) {
    ...
    public boolean equals(Object obj) {
        ...
        final TestModelSomeColumns other = (TestModelSomeColumns) obj;
