...
/**
 * This exception is thrown when an error occurs that is internal to the database. The developer would usually have no
 * control for fixing this exception. Should this exception ever arise you must contact BlobCity administrators using
 * the standard support contact points.
 *
